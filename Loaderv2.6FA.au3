...
Func LoadIPA($Selectedwhat, $ipapassword)
	...
	Sleep(200)
	ControlSetText("Select package.", "", "Edit1", $Selectedwhat, 1)
;~ 	Exit
	Sleep(200)
	...
	Sleep(250)
	ControlSetText("Apple ID Username", "", "Edit1", $sDecryptedUsername, 1)
	Sleep(100)
	ControlClick("Apple ID Username", "", "Button1", "primary", 1)
	Sleep(100)
	WinWait("Apple ID Password")
	WinActivate("Apple ID Password")
	ControlSetText("Apple ID Password", "", "Edit1", $ipapassword, 1)
	Sleep(100)
